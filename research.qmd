...
**Alternative approaches to the teaching of Spanish to adult immigrants and refugees** <br> This project tested 'non-traditional' approaches (task-based learning, cooperative learning, and writing as a social task) for teaching upper-beginning Spanish in an immigrant setting in Barcelona, Spain. This study addressed a significant research gap in the literature regarding this population, despite being Spain one of the main destinations for international migration (Consejo Económico y Social, 2019). You can read about this project [here](https://diposit.ub.edu/dspace/handle/2445/172322){.external target="_blank"} and in [Boletín ASELE, núm. 66](https://static1.squarespace.com/static/5f45150b2aa4295ff896cf08/t/653814b0aa65001249a664c6/1698174132786/Boletin_ASELE_66.pdf){.external target="_blank"}.
...
Feliu-Ribas, M. (April 2025) “Experimental Methods in Sociolinguistics: A Practical Introduction”. Sociolinguistic Analysis Group (SlAnG Lab), Rutgers University, NJ. 
